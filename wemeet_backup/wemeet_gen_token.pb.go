...
func (x *GenerateTokenReq) Reset() {
	*x = GenerateTokenReq{}
	mi := &file_wemeet_gen_token_proto_msgTypes[0]
...
func (*GenerateTokenReq) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserInfo) Reset() {
	*x = UserInfo{}
	mi := &file_wemeet_gen_token_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserInfo) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{1}
}
...
func (x *UserMetadata) Reset() {
	*x = UserMetadata{}
	mi := &file_wemeet_gen_token_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserMetadata) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{2}
}
...
func (x *WeMeetTokenClaims) Reset() {
	*x = WeMeetTokenClaims{}
	mi := &file_wemeet_gen_token_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WeMeetTokenClaims) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeMeetTokenClaims) ProtoMessage() {}

func (x *WeMeetTokenClaims) ProtoReflect() protoreflect.Message {
	mi := &file_wemeet_gen_token_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WeMeetTokenClaims.ProtoReflect.Descriptor instead.
func (*WeMeetTokenClaims) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{3}
}

func (x *WeMeetTokenClaims) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *WeMeetTokenClaims) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *WeMeetTokenClaims) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *WeMeetTokenClaims) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
func (x *WeMeetTokenClaims) GetIsHidden() bool {
	if x != nil {
		return x.IsHidden
	}
	return false
...
func (x *LockSettings) Reset() {
	*x = LockSettings{}
	mi := &file_wemeet_gen_token_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LockSettings) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{4}
}
...
func (x *GenerateTokenRes) Reset() {
	*x = GenerateTokenRes{}
	mi := &file_wemeet_gen_token_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateTokenRes) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{5}
}
...
func (x *CustomDesignParams) Reset() {
	*x = CustomDesignParams{}
	mi := &file_wemeet_gen_token_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomDesignParams) Descriptor() ([]byte, []int) {
	return file_wemeet_gen_token_proto_rawDescGZIP(), []int{6}
}
...
var File_wemeet_gen_token_proto protoreflect.FileDescriptor

const file_wemeet_gen_token_proto_rawDesc = "" +
	"\n" +
	"\x16wemeet_gen_token.proto\x12\x06wemeet\x1a\x1bbuf/validate/validate.proto\"\xe0\x01\n" +
	"\x10GenerateTokenReq\x12\x94\x01\n" +
	"\aroom_id\x18\x01 \x01(\tB{\xbaHx\xba\x01u\n" +
	"\x0eroom_id_format\x12Aroom_id should only contain letters (a-z A-Z), digits (0-9) or -_\x1a this.matches('^[a-zA-Z0-9-_]+$')R\x06roomId\x125\n" +
	"\tuser_info\x18\x02 \x01(\v2\x10.wemeet.UserInfoB\x06\xbaH\x03\xc8\x01\x01R\buserInfo\"\xb2\x01\n" +
	"\bUserInfo\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x19\n" +
	"\bis_admin\x18\x03 \x01(\bR\aisAdmin\x12\x1b\n" +
	"\tis_hidden\x18\x04 \x01(\bR\bisHidden\x129\n" +
	"\ruser_metadata\x18\x05 \x01(\v2\x14.wemeet.UserMetadataR\fuserMetadata\"\x9f\x05\n" +
	"\fUserMetadata\x12.\n" +
	...
	"\x0epreferred_lang\x18\a \x01(\tH\x02R\rpreferredLang\x88\x01\x01\x129\n" +
	"\rlock_settings\x18\b \x01(\v2\x14.wemeet.LockSettingsR\flockSettings\x12~\n" +
	...
	"\f_metadata_idB\r\n" +
	"\v_extra_dataB\r\n" +
	"\v_ex_user_id\"\x91\x01\n" +
	"\x11WeMeetTokenClaims\x12\x12\n" +
	...
	"\f_custom_logoB\x87\x01\n" +
	"\n" +
	"com.wemeetB\x13WemeetGenTokenProtoP\x01Z,github.com/retawsolit/wemeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_gen_token_proto_rawDescOnce sync.Once
	file_wemeet_gen_token_proto_rawDescData []byte
)

func file_wemeet_gen_token_proto_rawDescGZIP() []byte {
	file_wemeet_gen_token_proto_rawDescOnce.Do(func() {
		file_wemeet_gen_token_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_gen_token_proto_rawDesc), len(file_wemeet_gen_token_proto_rawDesc)))
	})
	return file_wemeet_gen_token_proto_rawDescData
}

var file_wemeet_gen_token_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_wemeet_gen_token_proto_goTypes = []any{
	(*GenerateTokenReq)(nil),   // 0: wemeet.GenerateTokenReq
	(*UserInfo)(nil),           // 1: wemeet.UserInfo
	(*UserMetadata)(nil),       // 2: wemeet.UserMetadata
	(*WeMeetTokenClaims)(nil),  // 3: wemeet.WeMeetTokenClaims
	(*LockSettings)(nil),       // 4: wemeet.LockSettings
	(*GenerateTokenRes)(nil),   // 5: wemeet.GenerateTokenRes
	(*CustomDesignParams)(nil), // 6: wemeet.CustomDesignParams
}
var file_wemeet_gen_token_proto_depIdxs = []int32{
	1, // 0: wemeet.GenerateTokenReq.user_info:type_name -> wemeet.UserInfo
	2, // 1: wemeet.UserInfo.user_metadata:type_name -> wemeet.UserMetadata
	4, // 2: wemeet.UserMetadata.lock_settings:type_name -> wemeet.LockSettings
...
func init() { file_wemeet_gen_token_proto_init() }
func file_wemeet_gen_token_proto_init() {
	if File_wemeet_gen_token_proto != nil {
		return
	}
	file_wemeet_gen_token_proto_msgTypes[2].OneofWrappers = []any{}
	file_wemeet_gen_token_proto_msgTypes[4].OneofWrappers = []any{}
	file_wemeet_gen_token_proto_msgTypes[5].OneofWrappers = []any{}
	file_wemeet_gen_token_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_gen_token_proto_rawDesc), len(file_wemeet_gen_token_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_gen_token_proto_goTypes,
		DependencyIndexes: file_wemeet_gen_token_proto_depIdxs,
		MessageInfos:      file_wemeet_gen_token_proto_msgTypes,
	}.Build()
	File_wemeet_gen_token_proto = out.File
	file_wemeet_gen_token_proto_goTypes = nil
	file_wemeet_gen_token_proto_depIdxs = nil
}
