...
func (AnalyticsEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_wemeet_analytics_proto_enumTypes[0].Descriptor()
}

func (AnalyticsEventType) Type() protoreflect.EnumType {
	return &file_wemeet_analytics_proto_enumTypes[0]
}
...
func (AnalyticsEventType) EnumDescriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{0}
}
...
func (AnalyticsEvents) Descriptor() protoreflect.EnumDescriptor {
	return file_wemeet_analytics_proto_enumTypes[1].Descriptor()
}

func (AnalyticsEvents) Type() protoreflect.EnumType {
	return &file_wemeet_analytics_proto_enumTypes[1]
}
...
func (AnalyticsEvents) EnumDescriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{1}
}
...
func (AnalyticsStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_wemeet_analytics_proto_enumTypes[2].Descriptor()
}

func (AnalyticsStatus) Type() protoreflect.EnumType {
	return &file_wemeet_analytics_proto_enumTypes[2]
}
...
func (AnalyticsStatus) EnumDescriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{2}
}

type AnalyticsDataMsg struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	EventType AnalyticsEventType     `protobuf:"varint,1,opt,name=event_type,json=eventType,proto3,enum=wemeet.AnalyticsEventType" json:"event_type,omitempty"`
	EventName AnalyticsEvents        `protobuf:"varint,2,opt,name=event_name,json=eventName,proto3,enum=wemeet.AnalyticsEvents" json:"event_name,omitempty"`
...
func (x *AnalyticsDataMsg) Reset() {
	*x = AnalyticsDataMsg{}
	mi := &file_wemeet_analytics_proto_msgTypes[0]
...
func (x *AnalyticsEventValue) Reset() {
	*x = AnalyticsEventValue{}
	mi := &file_wemeet_analytics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AnalyticsEventData) Reset() {
	*x = AnalyticsEventData{}
	mi := &file_wemeet_analytics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AnalyticsRoomInfo) Reset() {
	*x = AnalyticsRoomInfo{}
	mi := &file_wemeet_analytics_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsRoomInfo) Descriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{3}
}
...
func (x *AnalyticsUserInfo) Reset() {
	*x = AnalyticsUserInfo{}
	mi := &file_wemeet_analytics_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsUserInfo) Descriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{4}
}
...
func (x *AnalyticsResult) Reset() {
	*x = AnalyticsResult{}
	mi := &file_wemeet_analytics_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsResult) Descriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{5}
}
...
func (x *AnalyticsRedisUserInfo) Reset() {
	*x = AnalyticsRedisUserInfo{}
	mi := &file_wemeet_analytics_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsRedisUserInfo) Descriptor() ([]byte, []int) {
	return file_wemeet_analytics_proto_rawDescGZIP(), []int{6}
}
...
var File_wemeet_analytics_proto protoreflect.FileDescriptor

const file_wemeet_analytics_proto_rawDesc = "" +
	"\n" +
	"\x16wemeet_analytics.proto\x12\x06wemeet\"\xb6\x04\n" +
	"\x10AnalyticsDataMsg\x129\n" +
	"\n" +
	"event_type\x18\x01 \x01(\x0e2\x1a.wemeet.AnalyticsEventTypeR\teventType\x126\n" +
	"\n" +
	"event_name\x18\x02 \x01(\x0e2\x17.wemeet.AnalyticsEventsR\teventName\x12\x17\n" +
	...
	"\x05total\x18\x02 \x01(\rR\x05total\x123\n" +
	"\x06values\x18\x03 \x03(\v2\x1b.wemeet.AnalyticsEventValueR\x06values\"\xb5\x02\n" +
	...
	"\fenabled_e2ee\x18\a \x01(\bR\venabledE2ee\x122\n" +
	"\x06events\x18\t \x03(\v2\x1a.wemeet.AnalyticsEventDataR\x06events\"\xf4\x01\n" +
	...
	"\n" +
	"ex_user_id\x18\x05 \x01(\tH\x01R\bexUserId\x88\x01\x01\x122\n" +
	"\x06events\x18\x06 \x03(\v2\x1a.wemeet.AnalyticsEventDataR\x06eventsB\r\n" +
	"\v_extra_dataB\r\n" +
	"\v_ex_user_id\"q\n" +
	"\x0fAnalyticsResult\x12-\n" +
	"\x04room\x18\x01 \x01(\v2\x19.wemeet.AnalyticsRoomInfoR\x04room\x12/\n" +
	"\x05users\x18\x02 \x03(\v2\x19.wemeet.AnalyticsUserInfoR\x05users\"\xba\x01\n" +
	...
	"\x18ANALYTICS_STATUS_UNMUTED\x10\x03B\x88\x01\n" +
	"\n" +
	"com.wemeetB\x14WemeetAnalyticsProtoP\x01Z,github.com/retawsolit/wemeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_analytics_proto_rawDescOnce sync.Once
	file_wemeet_analytics_proto_rawDescData []byte
)

func file_wemeet_analytics_proto_rawDescGZIP() []byte {
	file_wemeet_analytics_proto_rawDescOnce.Do(func() {
		file_wemeet_analytics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_analytics_proto_rawDesc), len(file_wemeet_analytics_proto_rawDesc)))
	})
	return file_wemeet_analytics_proto_rawDescData
}

var file_wemeet_analytics_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_wemeet_analytics_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_wemeet_analytics_proto_goTypes = []any{
	(AnalyticsEventType)(0),        // 0: wemeet.AnalyticsEventType
	(AnalyticsEvents)(0),           // 1: wemeet.AnalyticsEvents
	(AnalyticsStatus)(0),           // 2: wemeet.AnalyticsStatus
	(*AnalyticsDataMsg)(nil),       // 3: wemeet.AnalyticsDataMsg
	(*AnalyticsEventValue)(nil),    // 4: wemeet.AnalyticsEventValue
	(*AnalyticsEventData)(nil),     // 5: wemeet.AnalyticsEventData
	(*AnalyticsRoomInfo)(nil),      // 6: wemeet.AnalyticsRoomInfo
	(*AnalyticsUserInfo)(nil),      // 7: wemeet.AnalyticsUserInfo
	(*AnalyticsResult)(nil),        // 8: wemeet.AnalyticsResult
	(*AnalyticsRedisUserInfo)(nil), // 9: wemeet.AnalyticsRedisUserInfo
}
var file_wemeet_analytics_proto_depIdxs = []int32{
	0, // 0: wemeet.AnalyticsDataMsg.event_type:type_name -> wemeet.AnalyticsEventType
	1, // 1: wemeet.AnalyticsDataMsg.event_name:type_name -> wemeet.AnalyticsEvents
	4, // 2: wemeet.AnalyticsEventData.values:type_name -> wemeet.AnalyticsEventValue
	5, // 3: wemeet.AnalyticsRoomInfo.events:type_name -> wemeet.AnalyticsEventData
	5, // 4: wemeet.AnalyticsUserInfo.events:type_name -> wemeet.AnalyticsEventData
	6, // 5: wemeet.AnalyticsResult.room:type_name -> wemeet.AnalyticsRoomInfo
	7, // 6: wemeet.AnalyticsResult.users:type_name -> wemeet.AnalyticsUserInfo
...
func init() { file_wemeet_analytics_proto_init() }
func file_wemeet_analytics_proto_init() {
	if File_wemeet_analytics_proto != nil {
		return
	}
	file_wemeet_analytics_proto_msgTypes[0].OneofWrappers = []any{}
	file_wemeet_analytics_proto_msgTypes[4].OneofWrappers = []any{}
	file_wemeet_analytics_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_analytics_proto_rawDesc), len(file_wemeet_analytics_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_analytics_proto_goTypes,
		DependencyIndexes: file_wemeet_analytics_proto_depIdxs,
		EnumInfos:         file_wemeet_analytics_proto_enumTypes,
		MessageInfos:      file_wemeet_analytics_proto_msgTypes,
	}.Build()
	File_wemeet_analytics_proto = out.File
	file_wemeet_analytics_proto_goTypes = nil
	file_wemeet_analytics_proto_depIdxs = nil
}
