...
// Validate checks the field values on wemeetTokenClaims with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *WeMeetTokenClaims) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on wemeetTokenClaims with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// WeMeetTokenClaimsMultiError, or nil if none found.
func (m *WeMeetTokenClaims) ValidateAll() error {
	return m.validate(true)
}

func (m *WeMeetTokenClaims) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return WeMeetTokenClaimsMultiError(errors)
	}

	return nil
}

// WeMeetTokenClaimsMultiError is an error wrapping multiple validation
// errors returned by wemeetTokenClaims.ValidateAll() if the designated
// constraints aren't met.
type WeMeetTokenClaimsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WeMeetTokenClaimsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WeMeetTokenClaimsMultiError) AllErrors() []error { return m }

// WeMeetTokenClaimsValidationError is the validation error returned by
// wemeetTokenClaims.Validate if the designated constraints aren't met.
type WeMeetTokenClaimsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WeMeetTokenClaimsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WeMeetTokenClaimsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WeMeetTokenClaimsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WeMeetTokenClaimsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WeMeetTokenClaimsValidationError) ErrorName() string {
	return "WeMeetTokenClaimsValidationError"
}

// Error satisfies the builtin error interface
func (e WeMeetTokenClaimsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWeMeetTokenClaims.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WeMeetTokenClaimsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WeMeetTokenClaimsValidationError{}
