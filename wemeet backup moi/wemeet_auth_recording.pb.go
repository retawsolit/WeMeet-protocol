...
const file_wemeet_auth_recording_proto_rawDesc = "" +
	"\n" +
	"\x1ewemeet_auth_recording.proto\x12\twemeet\x1a\x1bbuf/validate/validate.proto\x1a\x19wemeet_auth_room.proto\"t\n" +
	...
	"\x0frecordings_list\x18\x05 \x03(\v2\x18.wemeet.RecordingInfoR\x0erecordingsList\"x\n" +
	"\x12FetchRecordingsRes\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x128\n" +
	"\x06result\x18\x03 \x01(\v2 .wemeet.FetchRecordingsResultR\x06result\"7\n" +
	...
	"\x0erecording_info\x18\x03 \x01(\v2\x18.wemeet.RecordingInfoR\rrecordingInfo\x124\n" +
	"\troom_info\x18\x04 \x01(\v2\x17.wemeet.PastRoomInfoR\broomInfo\"9\n" +
	...
	"\x06_tokenB\xa4\x01\n" +
	"\rcom.wemeetB\x1bWemeetAuthRecordingProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
