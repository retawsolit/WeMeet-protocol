...
func (NatsMsgServerToClientEvents) Descriptor() protoreflect.EnumDescriptor {
	return File_wemeet_nats_msg_proto_enumTypes[0].Descriptor()
}

func (NatsMsgServerToClientEvents) Type() protoreflect.EnumType {
	return &File_wemeet_nats_msg_proto_enumTypes[0]
}
...
func (NatsMsgServerToClientEvents) EnumDescriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{0}
}
...
func (NatsMsgClientToServerEvents) Descriptor() protoreflect.EnumDescriptor {
	return File_wemeet_nats_msg_proto_enumTypes[1].Descriptor()
}

func (NatsMsgClientToServerEvents) Type() protoreflect.EnumType {
	return &File_wemeet_nats_msg_proto_enumTypes[1]
}
...
func (NatsMsgClientToServerEvents) EnumDescriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{1}
}
...
func (NatsSystemNotificationTypes) Descriptor() protoreflect.EnumDescriptor {
	return File_wemeet_nats_msg_proto_enumTypes[2].Descriptor()
}

func (NatsSystemNotificationTypes) Type() protoreflect.EnumType {
	return &File_wemeet_nats_msg_proto_enumTypes[2]
}
...
func (NatsSystemNotificationTypes) EnumDescriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{2}
}
...
func (x *NatsSubjects) Reset() {
	*x = NatsSubjects{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[0]
...
type NatsMsgServerToClient struct {
	...
	Event         NatsMsgServerToClientEvents `protobuf:"varint,2,opt,name=event,proto3,enum=wemeet.NatsMsgServerToClientEvents" json:"event,omitempty"`
...
func (x *NatsMsgServerToClient) Reset() {
	*x = NatsMsgServerToClient{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type NatsMsgClientToServer struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Id            string                      `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Event         NatsMsgClientToServerEvents `protobuf:"varint,2,opt,name=event,proto3,enum=wemeet.NatsMsgClientToServerEvents" json:"event,omitempty"`
	Msg           string                      `protobuf:"bytes,3,opt,name=msg,proto3" json:"msg,omitempty"`
...
func (x *NatsMsgClientToServer) Reset() {
	*x = NatsMsgClientToServer{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NatsKvRoomInfo) Reset() {
	*x = NatsKvRoomInfo{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKvRoomInfo) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{3}
}
...
func (x *NatsKvUserInfo) Reset() {
	*x = NatsKvUserInfo{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKvUserInfo) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{4}
}
...
func (x *MediaServerConnInfo) Reset() {
	*x = MediaServerConnInfo{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MediaServerConnInfo) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{5}
}
...
func (x *NatsInitialData) Reset() {
	*x = NatsInitialData{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsInitialData) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{6}
}
...
type NatsSystemNotification struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Id            string                      `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Type          NatsSystemNotificationTypes `protobuf:"varint,2,opt,name=type,proto3,enum=wemeet.NatsSystemNotificationTypes" json:"type,omitempty"`
	Msg           string                      `protobuf:"bytes,3,opt,name=msg,proto3" json:"msg,omitempty"`
...
func (x *NatsSystemNotification) Reset() {
	*x = NatsSystemNotification{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsSystemNotification) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{7}
}
...
func (x *NatsUserMetadataUpdate) Reset() {
	*x = NatsUserMetadataUpdate{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsUserMetadataUpdate) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{8}
}
...
func (x *ChatMessage) Reset() {
	*x = ChatMessage{}
	mi := &File_wemeet_nats_msg_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChatMessage) Descriptor() ([]byte, []int) {
	return File_wemeet_nats_msg_proto_rawDescGZIP(), []int{9}
}
...
var File_wemeet_nats_msg_proto protoreflect.FileDescriptor

const File_wemeet_nats_msg_proto_rawDesc = "" +
	"\n" +
	"\x18wemeet_nats_msg.proto\x12\twemeet\"\x87\x02\n" +
	"\fNatsSubjects\x12*\n" +
	...
	"\x05event\x18\x02 \x01(\x0e2&.wemeet.NatsMsgServerToClientEventsR\x05event\x12\x10\n" +
	"\x03msg\x18\x03 \x01(\tR\x03msg\"\x90\x01\n" +
	"\x15NatsMsgClientToServer\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12<\n" +
	"\x05event\x18\x02 \x01(\x0e2&.wemeet.NatsMsgClientToServerEventsR\x05event\x12\x10\n" +
	...
	"\x04room\x18\x01 \x01(\v2\x19.wemeet.NatsKvRoomInfoR\x04room\x128\n" +
	"\n" +
	"local_user\x18\x02 \x01(\v2\x19.wemeet.NatsKvUserInfoR\tlocalUser\x12J\n" +
	"\x11media_server_info\x18\x03 \x01(\v2\x1e.wemeet.MediaServerConnInfoR\x0fmediaServerInfo\"\xae\x01\n" +
	"\x16NatsSystemNotification\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12:\n" +
	"\x04type\x18\x02 \x01(\x0e2&.wemeet.NatsSystemNotificationTypesR\x04type\x12\x10\n" +
	"\x03msg\x18\x03 \x01(\tR\x03msg\x12\x17\n" +
	...
	"\rcom.wemeetB\x15WemeetNatsMsgProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"

var (
	File_wemeet_nats_msg_proto_rawDescOnce sync.Once
	File_wemeet_nats_msg_proto_rawDescData []byte
)

func File_wemeet_nats_msg_proto_rawDescGZIP() []byte {
	File_wemeet_nats_msg_proto_rawDescOnce.Do(func() {
		File_wemeet_nats_msg_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(File_wemeet_nats_msg_proto_rawDesc), len(File_wemeet_nats_msg_proto_rawDesc)))
	})
	return File_wemeet_nats_msg_proto_rawDescData
}

var File_wemeet_nats_msg_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var File_wemeet_nats_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var File_wemeet_nats_msg_proto_goTypes = []any{
	(NatsMsgServerToClientEvents)(0), // 0: wemeet.NatsMsgServerToClientEvents
	(NatsMsgClientToServerEvents)(0), // 1: wemeet.NatsMsgClientToServerEvents
	(NatsSystemNotificationTypes)(0), // 2: wemeet.NatsSystemNotificationTypes
	(*NatsSubjects)(nil),             // 3: wemeet.NatsSubjects
	(*NatsMsgServerToClient)(nil),    // 4: wemeet.NatsMsgServerToClient
	(*NatsMsgClientToServer)(nil),    // 5: wemeet.NatsMsgClientToServer
	(*NatsKvRoomInfo)(nil),           // 6: wemeet.NatsKvRoomInfo
	(*NatsKvUserInfo)(nil),           // 7: wemeet.NatsKvUserInfo
	(*MediaServerConnInfo)(nil),      // 8: wemeet.MediaServerConnInfo
	(*NatsInitialData)(nil),          // 9: wemeet.NatsInitialData
	(*NatsSystemNotification)(nil),   // 10: wemeet.NatsSystemNotification
	(*NatsUserMetadataUpdate)(nil),   // 11: wemeet.NatsUserMetadataUpdate
	(*ChatMessage)(nil),              // 12: wemeet.ChatMessage
}
var File_wemeet_nats_msg_proto_depIdxs = []int32{
	0, // 0: wemeet.NatsMsgServerToClient.event:type_name -> wemeet.NatsMsgServerToClientEvents
	1, // 1: wemeet.NatsMsgClientToServer.event:type_name -> wemeet.NatsMsgClientToServerEvents
	6, // 2: wemeet.NatsInitialData.room:type_name -> wemeet.NatsKvRoomInfo
	7, // 3: wemeet.NatsInitialData.local_user:type_name -> wemeet.NatsKvUserInfo
	8, // 4: wemeet.NatsInitialData.media_server_info:type_name -> wemeet.MediaServerConnInfo
	2, // 5: wemeet.NatsSystemNotification.type:type_name -> wemeet.NatsSystemNotificationTypes
...
func init() { File_wemeet_nats_msg_proto_init() }
func File_wemeet_nats_msg_proto_init() {
	if File_wemeet_nats_msg_proto != nil {
		return
	}
	File_wemeet_nats_msg_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(File_wemeet_nats_msg_proto_rawDesc), len(File_wemeet_nats_msg_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           File_wemeet_nats_msg_proto_goTypes,
		DependencyIndexes: File_wemeet_nats_msg_proto_depIdxs,
		EnumInfos:         File_wemeet_nats_msg_proto_enumTypes,
		MessageInfos:      File_wemeet_nats_msg_proto_msgTypes,
	}.Build()
	File_wemeet_nats_msg_proto = out.File
	File_wemeet_nats_msg_proto_goTypes = nil
	File_wemeet_nats_msg_proto_depIdxs = nil
}
