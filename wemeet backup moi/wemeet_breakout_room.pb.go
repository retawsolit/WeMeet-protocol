...
const file_wemeet_breakout_room_proto_rawDesc = "" +
	"\n" +
	"\x1dwemeet_breakout_room.proto\x12\twemeet\"\xde\x01\n" +
	...
	"\x05rooms\x18\x05 \x03(\v2\x17.wemeet.BreakoutRoomR\x05roomsB\x0e\n" +
	...
	"\x05users\x18\x06 \x03(\v2\x1b.wemeet.BreakoutRoomUserR\x05users\"N\n" +
	...
	"\x04room\x18\x04 \x01(\v2\x17.wemeet.BreakoutRoomH\x01R\x04room\x88\x01\x01\x12-\n" +
	"\x05rooms\x18\x05 \x03(\v2\x17.wemeet.BreakoutRoomR\x05roomsB\b\n" +
	"\x06_tokenB\a\n" +
	"\x05_roomB\xa3\x01\n" +
	"\rcom.wemeetB\x1aWemeetBreakoutRoomProtoP\x01Z2github.com/mynaparrot/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
