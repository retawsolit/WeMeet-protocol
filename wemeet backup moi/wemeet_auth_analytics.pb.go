...
const file_wemeet_auth_analytics_proto_rawDesc = "" +
	"\n" +
	"\x1ewemeet_auth_analytics.proto\x12\twemeet\x1a\x1bbuf/validate/validate.proto\"s\n" +
	...
	"\x0eanalytics_list\x18\x05 \x03(\v2\x18.wemeet.AnalyticsInfoR\ranalyticsList\"v\n" +
	"\x11FetchAnalyticsRes\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x127\n" +
	"\x06result\x18\x03 \x01(\v2\x1f.wemeet.FetchAnalyticsResultR\x06result\"5\n" +
	...
	"\x06_tokenB\xa4\x01\n" +
	"\rcom.wemeetB\x1bWemeetAuthAnalyticsProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
