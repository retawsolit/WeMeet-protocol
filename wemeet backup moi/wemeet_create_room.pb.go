...
const File_wemeet_create_room_proto_rawDesc = "" +
	"\n" +
	"\x1bwemeet_create_room.proto\x12\twemeet\x1a\x19wemeet_gen_token.proto\x1a\x1bbuf/validate/validate.proto\x1a\x17wemeet_ingress.proto\x1a\x19wemeet_auth_room.proto\"\xfd\x02\n" +
	...
	"\bmetadata\x18\x04 \x01(\v2\x17.wemeet.RoomMetadataB\x06\xbaH\x03\xc8\x01\x01R\bmetadataB\x10\n" +
	...
	"\rroom_features\x18\n" +
	" \x01(\v2\x1d.wemeet.RoomCreateFeaturesB\x06\xbaH\x03\xc8\x01\x01R\froomFeatures\x12K\n" +
	"\x15default_lock_settings\x18\v \x01(\v2\x17.wemeet.LockSettingsR\x13defaultLockSettings\x12?\n" +
	"\x0ecopyright_conf\x18\f \x01(\v2\x18.wemeet.CopyrightConfR\rcopyrightConf\x12~\n" +
	...
	"\x12recording_features\x18\x0e \x01(\v2\x1c.wemeet.RecordingFeaturesR\x11recordingFeatures\x12<\n" +
	"\rchat_features\x18\x0f \x01(\v2\x17.wemeet.ChatFeaturesR\fchatFeatures\x12Y\n" +
	"\x18shared_note_pad_features\x18\x10 \x01(\v2 .wemeet.SharedNotePadFeaturesR\x15sharedNotePadFeatures\x12N\n" +
	"\x13whiteboard_features\x18\x11 \x01(\v2\x1d.wemeet.WhiteboardFeaturesR\x12whiteboardFeatures\x12k\n" +
	"\x1eexternal_media_player_features\x18\x12 \x01(\v2&.wemeet.ExternalMediaPlayerFeaturesR\x1bexternalMediaPlayerFeatures\x12R\n" +
	"\x15waiting_room_features\x18\x13 \x01(\v2\x1e.wemeet.WaitingRoomFeaturesR\x13waitingRoomFeatures\x12U\n" +
	"\x16breakout_room_features\x18\x14 \x01(\v2\x1f.wemeet.BreakoutRoomFeaturesR\x14breakoutRoomFeatures\x12k\n" +
	"\x1edisplay_external_link_features\x18\x15 \x01(\v2&.wemeet.DisplayExternalLinkFeaturesR\x1bdisplayExternalLinkFeatures\x12E\n" +
	"\x10ingress_features\x18\x16 \x01(\v2\x1a.wemeet.IngressFeaturesR\x0fingressFeatures\x12x\n" +
	"#speech_to_text_translation_features\x18\x17 \x01(\v2*.wemeet.SpeechToTextTranslationFeaturesR\x1fspeechToTextTranslationFeatures\x12i\n" +
	"\x1eend_to_end_encryption_features\x18\x18 \x01(\v2%.wemeet.EndToEndEncryptionFeaturesR\x1aendToEndEncryptionFeatures\x12?\n" +
	"\x0epolls_features\x18\x19 \x01(\v2\x18.wemeet.PollsFeaturesR\rpollsFeaturesB\x10\n" +
	...
	"\n" +
	"input_type\x18\x02 \x01(\x0e2\x17.wemeet.IngressInputR\tinputType\x12Z\n" +
	...
	"\troom_info\x18\x03 \x01(\v2\x19.wemeet.ActiveRoomInfoR\broomInfoB\xa1\x01\n" +
	"\rcom.wemeetB\x18WemeetCreateRoomProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
