...
const file_wemeet_auth_room_proto_rawDesc = "" +
	"\n" +
	"\x19wemeet_auth_room.proto\x12\twemeet\x1a\x14livekit_models.proto\x1a\x1bbuf/validate/validate.proto\"7\n" +
	...
	"\troom_info\x18\x03 \x01(\v2\x19.wemeet.ActiveRoomInfoH\x00R\broomInfo\x88\x01\x01\x12E\n" +
	...
	"\x04room\x18\x03 \x01(\v2$.wemeet.ActiveRoomWithParticipantR\x04room\"}\n" +
	...
	"\n" +
	"rooms_list\x18\x05 \x03(\v2\x17.wemeet.PastRoomInfoR\troomsList\"v\n" +
	"\x11FetchPastRoomsRes\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x127\n" +
	"\x06result\x18\x03 \x01(\v2\x1f.wemeet.FetchPastRoomsResultR\x06resultB\x9f\x01\n" +
	"\rcom.wemeetB\x16WemeetAuthRoomProtoP\x01Z2github.com/retawsolit/wemeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
