...
const File_wemeet_polls_proto_rawDesc = "" +
	"\n" +
	"\x15wemeet_polls.proto\x12\twemeet\"H\n" +
	...
	"\aoptions\x18\x05 \x03(\v2\x1c.wemeet.CreatePollOptionsR\aoptions\"7\n" +
	...
	"\aoptions\x18\x04 \x03(\v2\x1c.wemeet.CreatePollOptionsR\aoptions\x12\x1d\n" +
	"\n" +
	...
	"\x05polls\x18\a \x03(\v2\x13.wemeet.PollInfoR\x05polls\x120\n" +
	"\x05stats\x18\b \x01(\v2\x15.wemeet.PollsStatsH\x03R\x05stats\x88\x01\x01\x12$\n" +
	"\vtotal_polls\x18\t \x01(\x04H\x04R\n" +
	"totalPolls\x88\x01\x01\x12(\n" +
	"\rtotal_running\x18\n" +
	" \x01(\x04H\x05R\ftotalRunning\x88\x01\x01\x12W\n" +
	"\x15poll_responses_result\x18\v \x01(\v2\x1e.wemeet.PollResponsesResultH\x06R\x13pollResponsesResult\x88\x01\x01\x1a<\n" +
	...
	"\rcom.wemeetB\x13WemeetPollsProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
