...
const file_wemeet_analytics_proto_rawDesc = "" +
	"\n" +
	"\x19wemeet_analytics.proto\x12\twemeet\"\xbc\x04\n" +
	"\x10AnalyticsDataMsg\x12<\n" +
	"\n" +
	"event_type\x18\x01 \x01(\x0e2\x1d.wemeet.AnalyticsEventTypeR\teventType\x129\n" +
	"\n" +
	"event_name\x18\x02 \x01(\x0e2\x1a.wemeet.AnalyticsEventsR\teventName\x12\x17\n" +
	...
	"\x06values\x18\x03 \x03(\v2\x1e.wemeet.AnalyticsEventValueR\x06values\"\xb8\x02\n" +
	...
	"\x06events\x18\t \x03(\v2\x1d.wemeet.AnalyticsEventDataR\x06events\"\xf7\x01\n" +
	...
	"\x06events\x18\x06 \x03(\v2\x1d.wemeet.AnalyticsEventDataR\x06eventsB\r\n" +
	"\v_extra_dataB\r\n" +
	"\v_ex_user_id\"w\n" +
	"\x0fAnalyticsResult\x120\n" +
	"\x04room\x18\x01 \x01(\v2\x1c.wemeet.AnalyticsRoomInfoR\x04room\x122\n" +
	"\x05users\x18\x02 \x03(\v2\x1c.wemeet.AnalyticsUserInfoR\x05users\"\xba\x01\n" +
	...
	"\rcom.wemeetB\x17WemeetAnalyticsProtoP\x01Z2github.com/retawsolit/wemeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
