...
const File_wemeet_gen_token_proto_rawDesc = "" +
	"\n" +
	"\x19wemeet_gen_token.proto\x12\twemeet\x1a\x1bbuf/validate/validate.proto\"\xe3\x01\n" +
	...
	"\tuser_info\x18\x02 \x01(\v2\x13.wemeet.UserInfoB\x06\xbaH\x03\xc8\x01\x01R\buserInfo\"\xb5\x01\n" +
	"\bUserInfo\x12\x1a\n" +
	...
	"\ruser_metadata\x18\x05 \x01(\v2\x17.wemeet.UserMetadataR\fuserMetadata\"\xa2\x05\n" +
	"\fUserMetadata\x12.\n" +
	...
	"\rlock_settings\x18\b \x01(\v2\x17.wemeet.LockSettingsR\flockSettings\x12~\n" +
	...
	"\rcom.wemeetB\x16WemeetGenTokenProtoP\x01Z2github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03PXX\xaa\x02\tWemeet\xca\x02\tWemeet\xe2\x02\x15Wemeet\\GPBMetadata\xea\x02\tWemeetb\x06proto3"
