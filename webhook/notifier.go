...
func (n *Notifier) AddInNotifyQueue(event *wemeet.CommonNotifyEvent, apiKey, apiSecret string, urls []string) {
	if len(urls) < 1 {
		return
	}
...
func (n *Notifier) sendWebhookRequest(event *wemeet.CommonNotifyEvent, apiKey, apiSecret, url string) (*http.Response, error) {
