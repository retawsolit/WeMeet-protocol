...
const file_wemeet_recorder_proto_rawDesc = "" +
	"\n" +
	"\x15wemeet_recorder.proto\x12\x06wemeet\"\xbe\x02\n" +
	"\x10WeMeetToRecorder\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\x12*\n" +
	"\x04task\x18\x02 \x01(\x0e2\x16.wemeet.RecordingTasksR\x04task\x12\"\n" +
	...
	"\t_rtmp_url\"\xba\x03\n" +
	"\x10RecorderToWeMeet\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\x12*\n" +
	"\x04task\x18\x02 \x01(\x0e2\x16.wemeet.RecordingTasksR\x04task\x12\x16\n" +
	...
	"\tfile_size\x18\n" +
	" \x01(\x02R\bfileSize\x12P\n" +
	"\x11recording_variant\x18\f \x01(\x0e2\x1e.wemeet.CloudRecordingVariantsH\x00R\x10recordingVariant\x88\x01\x01B\x14\n" +
