...
// 	protoc        (unknown)
// source: wemeet_breakout_room.proto
...
func (x *CreateBreakoutRoomsReq) Reset() {
	*x = CreateBreakoutRoomsReq{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[0]
...
func (*CreateBreakoutRoomsReq) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{0}
}
...
func (x *BreakoutRoom) Reset() {
	*x = BreakoutRoom{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BreakoutRoom) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{1}
}
...
func (x *BreakoutRoomUser) Reset() {
	*x = BreakoutRoomUser{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BreakoutRoomUser) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{2}
}
...
func (x *IncreaseBreakoutRoomDurationReq) Reset() {
	*x = IncreaseBreakoutRoomDurationReq{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IncreaseBreakoutRoomDurationReq) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{3}
}
...
func (x *BroadcastBreakoutRoomMsgReq) Reset() {
	*x = BroadcastBreakoutRoomMsgReq{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BroadcastBreakoutRoomMsgReq) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{4}
}
...
func (x *JoinBreakoutRoomReq) Reset() {
	*x = JoinBreakoutRoomReq{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*JoinBreakoutRoomReq) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{5}
}
...
func (x *EndBreakoutRoomReq) Reset() {
	*x = EndBreakoutRoomReq{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EndBreakoutRoomReq) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{6}
}
...
func (x *BreakoutRoomRes) Reset() {
	*x = BreakoutRoomRes{}
	mi := &file_wemeet_breakout_room_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BreakoutRoomRes) Descriptor() ([]byte, []int) {
	return file_wemeet_breakout_room_proto_rawDescGZIP(), []int{7}
}
...
var File_wemeet_breakout_room_proto protoreflect.FileDescriptor

const file_wemeet_breakout_room_proto_rawDesc = "" +
	"\n" +
	"\x1awemeet_breakout_room.proto\x12\x06wemeet\"\xdb\x01\n" +
	...
	"\x05rooms\x18\x05 \x03(\v2\x14.wemeet.BreakoutRoomR\x05roomsB\x0e\n" +
	"\f_welcome_msg\"\xb4\x01\n" +
	"\fBreakoutRoom\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\x04R\bduration\x12\x18\n" +
	"\astarted\x18\x04 \x01(\bR\astarted\x12\x18\n" +
	"\acreated\x18\x05 \x01(\x04R\acreated\x12.\n" +
	"\x05users\x18\x06 \x03(\v2\x18.wemeet.BreakoutRoomUserR\x05users\"N\n" +
	...
	"\x10breakout_room_id\x18\x01 \x01(\tR\x0ebreakoutRoomId\x12\x17\n" +
	"\aroom_id\x18\x03 \x01(\tR\x06roomId\"\xc4\x01\n" +
	...
	"\x04room\x18\x04 \x01(\v2\x14.wemeet.BreakoutRoomH\x01R\x04room\x88\x01\x01\x12*\n" +
	"\x05rooms\x18\x05 \x03(\v2\x14.wemeet.BreakoutRoomR\x05roomsB\b\n" +
	"\x06_tokenB\a\n" +
	"\x05_roomB\x8b\x01\n" +
	"\n" +
	"com.wemeetB\x17WemeetBreakoutRoomProtoP\x01Z,github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_breakout_room_proto_rawDescOnce sync.Once
	file_wemeet_breakout_room_proto_rawDescData []byte
)

func file_wemeet_breakout_room_proto_rawDescGZIP() []byte {
	file_wemeet_breakout_room_proto_rawDescOnce.Do(func() {
		file_wemeet_breakout_room_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_breakout_room_proto_rawDesc), len(file_wemeet_breakout_room_proto_rawDesc)))
	})
	return file_wemeet_breakout_room_proto_rawDescData
}

var file_wemeet_breakout_room_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_wemeet_breakout_room_proto_goTypes = []any{
	(*CreateBreakoutRoomsReq)(nil),          // 0: wemeet.CreateBreakoutRoomsReq
	(*BreakoutRoom)(nil),                    // 1: wemeet.BreakoutRoom
	(*BreakoutRoomUser)(nil),                // 2: wemeet.BreakoutRoomUser
	(*IncreaseBreakoutRoomDurationReq)(nil), // 3: wemeet.IncreaseBreakoutRoomDurationReq
	(*BroadcastBreakoutRoomMsgReq)(nil),     // 4: wemeet.BroadcastBreakoutRoomMsgReq
	(*JoinBreakoutRoomReq)(nil),             // 5: wemeet.JoinBreakoutRoomReq
	(*EndBreakoutRoomReq)(nil),              // 6: wemeet.EndBreakoutRoomReq
	(*BreakoutRoomRes)(nil),                 // 7: wemeet.BreakoutRoomRes
}
var file_wemeet_breakout_room_proto_depIdxs = []int32{
	1, // 0: wemeet.CreateBreakoutRoomsReq.rooms:type_name -> wemeet.BreakoutRoom
	2, // 1: wemeet.BreakoutRoom.users:type_name -> wemeet.BreakoutRoomUser
	1, // 2: wemeet.BreakoutRoomRes.room:type_name -> wemeet.BreakoutRoom
	1, // 3: wemeet.BreakoutRoomRes.rooms:type_name -> wemeet.BreakoutRoom
...
func init() { file_wemeet_breakout_room_proto_init() }
func file_wemeet_breakout_room_proto_init() {
	if File_wemeet_breakout_room_proto != nil {
		return
	}
	file_wemeet_breakout_room_proto_msgTypes[0].OneofWrappers = []any{}
	file_wemeet_breakout_room_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_breakout_room_proto_rawDesc), len(file_wemeet_breakout_room_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_breakout_room_proto_goTypes,
		DependencyIndexes: file_wemeet_breakout_room_proto_depIdxs,
		MessageInfos:      file_wemeet_breakout_room_proto_msgTypes,
	}.Build()
	File_wemeet_breakout_room_proto = out.File
	file_wemeet_breakout_room_proto_goTypes = nil
	file_wemeet_breakout_room_proto_depIdxs = nil
}
