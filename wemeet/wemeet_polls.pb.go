...
func (x *ActivatePollsReq) Reset() {
	*x = ActivatePollsReq{}
	mi := &file_wemeet_polls_proto_msgTypes[0]
...
func (*ActivatePollsReq) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreatePollReq) Reset() {
	*x = CreatePollReq{}
	mi := &file_wemeet_polls_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreatePollReq) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreatePollOptions) Reset() {
	*x = CreatePollOptions{}
	mi := &file_wemeet_polls_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreatePollOptions) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{2}
}
...
func (x *PollInfo) Reset() {
	*x = PollInfo{}
	mi := &file_wemeet_polls_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollInfo) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{3}
}
...
func (x *SubmitPollResponseReq) Reset() {
	*x = SubmitPollResponseReq{}
	mi := &file_wemeet_polls_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubmitPollResponseReq) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{4}
}
...
func (x *ClosePollReq) Reset() {
	*x = ClosePollReq{}
	mi := &file_wemeet_polls_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClosePollReq) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{5}
}
...
func (x *PollResponsesResultOptions) Reset() {
	*x = PollResponsesResultOptions{}
	mi := &file_wemeet_polls_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollResponsesResultOptions) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{6}
}
...
func (x *PollResponsesResult) Reset() {
	*x = PollResponsesResult{}
	mi := &file_wemeet_polls_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollResponsesResult) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{7}
}
...
func (x *PollsStats) Reset() {
	*x = PollsStats{}
	mi := &file_wemeet_polls_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollsStats) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{8}
}
...
func (x *PollResponse) Reset() {
	*x = PollResponse{}
	mi := &file_wemeet_polls_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollResponse) Descriptor() ([]byte, []int) {
	return file_wemeet_polls_proto_rawDescGZIP(), []int{9}
}
...
var File_wemeet_polls_proto protoreflect.FileDescriptor

const file_wemeet_polls_proto_rawDesc = "" +
	"\n" +
	"\x12wemeet_polls.proto\x12\x06wemeet\"H\n" +
	"\x10ActivatePollsReq\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12\x1b\n" +
	"\tis_active\x18\x02 \x01(\bR\bisActive\"\xab\x01\n" +
	"\rCreatePollReq\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x17\n" +
	"\apoll_id\x18\x03 \x01(\tR\x06pollId\x12\x1a\n" +
	"\bquestion\x18\x04 \x01(\tR\bquestion\x123\n" +
	"\aoptions\x18\x05 \x03(\v2\x19.wemeet.CreatePollOptionsR\aoptions\"7\n" +
	...
	"\aoptions\x18\x04 \x03(\v2\x19.wemeet.CreatePollOptionsR\aoptions\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"vote_count\x18\x03 \x01(\x04R\tvoteCount\"\x98\x01\n" +
	...
	"\aoptions\x18\x03 \x03(\v2\".wemeet.PollResponsesResultOptionsR\aoptions\"R\n" +
	"\n" +
	"PollsStats\x12\x1f\n" +
	"\vtotal_polls\x18\x01 \x01(\x04R\n" +
	"totalPolls\x12#\n" +
	"\rtotal_running\x18\x02 \x01(\x04R\ftotalRunning\"\x8d\x05\n" +
	...
	"\x05voted\x18\x05 \x01(\x04H\x02R\x05voted\x88\x01\x01\x12A\n" +
	"\tresponses\x18\x06 \x03(\v2#.wemeet.PollResponse.ResponsesEntryR\tresponses\x12&\n" +
	"\x05polls\x18\a \x03(\v2\x10.wemeet.PollInfoR\x05polls\x12-\n" +
	"\x05stats\x18\b \x01(\v2\x12.wemeet.PollsStatsH\x03R\x05stats\x88\x01\x01\x12$\n" +
	"\vtotal_polls\x18\t \x01(\x04H\x04R\n" +
	"totalPolls\x88\x01\x01\x12(\n" +
	"\rtotal_running\x18\n" +
	" \x01(\x04H\x05R\ftotalRunning\x88\x01\x01\x12T\n" +
	"\x15poll_responses_result\x18\v \x01(\v2\x1b.wemeet.PollResponsesResultH\x06R\x13pollResponsesResult\x88\x01\x01\x1a<\n" +
...
var (
	...
	file_wemeet_polls_proto_rawDescData []byte
)

func file_wemeet_polls_proto_rawDescGZIP() []byte {
	file_wemeet_polls_proto_rawDescOnce.Do(func() {
		file_wemeet_polls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_polls_proto_rawDesc), len(file_wemeet_polls_proto_rawDesc)))
	})
	return file_wemeet_polls_proto_rawDescData
}

var file_wemeet_polls_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_wemeet_polls_proto_goTypes = []any{
	(*ActivatePollsReq)(nil),           // 0: wemeet.ActivatePollsReq
	(*CreatePollReq)(nil),              // 1: wemeet.CreatePollReq
	(*CreatePollOptions)(nil),          // 2: wemeet.CreatePollOptions
	(*PollInfo)(nil),                   // 3: wemeet.PollInfo
	(*SubmitPollResponseReq)(nil),      // 4: wemeet.SubmitPollResponseReq
	(*ClosePollReq)(nil),               // 5: wemeet.ClosePollReq
	(*PollResponsesResultOptions)(nil), // 6: wemeet.PollResponsesResultOptions
	(*PollResponsesResult)(nil),        // 7: wemeet.PollResponsesResult
	(*PollsStats)(nil),                 // 8: wemeet.PollsStats
	(*PollResponse)(nil),               // 9: wemeet.PollResponse
	nil,                                // 10: wemeet.PollResponse.ResponsesEntry
}
var file_wemeet_polls_proto_depIdxs = []int32{
	2,  // 0: wemeet.CreatePollReq.options:type_name -> wemeet.CreatePollOptions
	2,  // 1: wemeet.PollInfo.options:type_name -> wemeet.CreatePollOptions
	6,  // 2: wemeet.PollResponsesResult.options:type_name -> wemeet.PollResponsesResultOptions
	10, // 3: wemeet.PollResponse.responses:type_name -> wemeet.PollResponse.ResponsesEntry
	3,  // 4: wemeet.PollResponse.polls:type_name -> wemeet.PollInfo
	8,  // 5: wemeet.PollResponse.stats:type_name -> wemeet.PollsStats
	7,  // 6: wemeet.PollResponse.poll_responses_result:type_name -> wemeet.PollResponsesResult
...
func init() { file_wemeet_polls_proto_init() }
func file_wemeet_polls_proto_init() {
	if File_wemeet_polls_proto != nil {
		return
	}
	file_wemeet_polls_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_polls_proto_rawDesc), len(file_wemeet_polls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_polls_proto_goTypes,
		DependencyIndexes: file_wemeet_polls_proto_depIdxs,
		MessageInfos:      file_wemeet_polls_proto_msgTypes,
	}.Build()
	File_wemeet_polls_proto = out.File
	file_wemeet_polls_proto_goTypes = nil
	file_wemeet_polls_proto_depIdxs = nil
}
