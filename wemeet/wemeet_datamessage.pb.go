...
// 	protoc        (unknown)
// source: wemeet_datamessage.proto
...
func (DataMsgBodyType) Descriptor() protoreflect.EnumDescriptor {
	return file_wemeet_datamessage_proto_enumTypes[0].Descriptor()
}

func (DataMsgBodyType) Type() protoreflect.EnumType {
	return &file_wemeet_datamessage_proto_enumTypes[0]
}
...
func (DataMsgBodyType) EnumDescriptor() ([]byte, []int) {
	return file_wemeet_datamessage_proto_rawDescGZIP(), []int{0}
}

type DataChannelMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Type          DataMsgBodyType        `protobuf:"varint,2,opt,name=type,proto3,enum=wemeet.DataMsgBodyType" json:"type,omitempty"`
...
func (x *DataChannelMessage) Reset() {
	*x = DataChannelMessage{}
	mi := &file_wemeet_datamessage_proto_msgTypes[0]
...
var File_wemeet_datamessage_proto protoreflect.FileDescriptor

const file_wemeet_datamessage_proto_rawDesc = "" +
	"\n" +
	"\x18wemeet_datamessage.proto\x12\x06wemeet\"\xbf\x01\n" +
	"\x12DataChannelMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12+\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.wemeet.DataMsgBodyTypeR\x04type\x12 \n" +
	...
	"\x1eUSER_CONNECTION_QUALITY_CHANGE\x10\x10B\x8a\x01\n" +
	"\n" +
	"com.wemeetB\x16WemeetDatamessageProtoP\x01Z,github.com/retawsolit/wemeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_datamessage_proto_rawDescOnce sync.Once
	file_wemeet_datamessage_proto_rawDescData []byte
)

func file_wemeet_datamessage_proto_rawDescGZIP() []byte {
	file_wemeet_datamessage_proto_rawDescOnce.Do(func() {
		file_wemeet_datamessage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_datamessage_proto_rawDesc), len(file_wemeet_datamessage_proto_rawDesc)))
	})
	return file_wemeet_datamessage_proto_rawDescData
}

var file_wemeet_datamessage_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wemeet_datamessage_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_wemeet_datamessage_proto_goTypes = []any{
	(DataMsgBodyType)(0),       // 0: wemeet.DataMsgBodyType
	(*DataChannelMessage)(nil), // 1: wemeet.DataChannelMessage
}
var file_wemeet_datamessage_proto_depIdxs = []int32{
	0, // 0: wemeet.DataChannelMessage.type:type_name -> wemeet.DataMsgBodyType
...
func init() { file_wemeet_datamessage_proto_init() }
func file_wemeet_datamessage_proto_init() {
	if File_wemeet_datamessage_proto != nil {
		return
	}
	file_wemeet_datamessage_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_datamessage_proto_rawDesc), len(file_wemeet_datamessage_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_datamessage_proto_goTypes,
		DependencyIndexes: file_wemeet_datamessage_proto_depIdxs,
		EnumInfos:         file_wemeet_datamessage_proto_enumTypes,
		MessageInfos:      file_wemeet_datamessage_proto_msgTypes,
	}.Build()
	File_wemeet_datamessage_proto = out.File
	file_wemeet_datamessage_proto_goTypes = nil
	file_wemeet_datamessage_proto_depIdxs = nil
}
