...
// 	protoc        (unknown)
// source: wemeet_speech_services.proto
...
func (SpeechServiceUserStatusTasks) Descriptor() protoreflect.EnumDescriptor {
	return file_wemeet_speech_services_proto_enumTypes[0].Descriptor()
}

func (SpeechServiceUserStatusTasks) Type() protoreflect.EnumType {
	return &file_wemeet_speech_services_proto_enumTypes[0]
}
...
func (SpeechServiceUserStatusTasks) EnumDescriptor() ([]byte, []int) {
	return file_wemeet_speech_services_proto_rawDescGZIP(), []int{0}
}
...
func (x *SpeechToTextTranslationReq) Reset() {
	*x = SpeechToTextTranslationReq{}
	mi := &file_wemeet_speech_services_proto_msgTypes[0]
...
func (x *GenerateAzureTokenReq) Reset() {
	*x = GenerateAzureTokenReq{}
	mi := &file_wemeet_speech_services_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateAzureTokenReq) Descriptor() ([]byte, []int) {
	return file_wemeet_speech_services_proto_rawDescGZIP(), []int{1}
}
...
func (x *GenerateAzureTokenRes) Reset() {
	*x = GenerateAzureTokenRes{}
	mi := &file_wemeet_speech_services_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateAzureTokenRes) Descriptor() ([]byte, []int) {
	return file_wemeet_speech_services_proto_rawDescGZIP(), []int{2}
}
...
func (x *AzureTokenRenewReq) Reset() {
	*x = AzureTokenRenewReq{}
	mi := &file_wemeet_speech_services_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureTokenRenewReq) Descriptor() ([]byte, []int) {
	return file_wemeet_speech_services_proto_rawDescGZIP(), []int{3}
}
...
type SpeechServiceUserStatusReq struct {
	...
	KeyId         string                       `protobuf:"bytes,4,opt,name=key_id,json=keyId,proto3" json:"key_id,omitempty"`
	Task          SpeechServiceUserStatusTasks `protobuf:"varint,5,opt,name=task,proto3,enum=wemeet.SpeechServiceUserStatusTasks" json:"task,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SpeechServiceUserStatusReq) Reset() {
	*x = SpeechServiceUserStatusReq{}
	mi := &file_wemeet_speech_services_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpeechServiceUserStatusReq) Descriptor() ([]byte, []int) {
	return file_wemeet_speech_services_proto_rawDescGZIP(), []int{4}
}
...
var File_wemeet_speech_services_proto protoreflect.FileDescriptor

const file_wemeet_speech_services_proto_rawDesc = "" +
	"\n" +
	"\x1cwemeet_speech_services.proto\x12\x06wemeet\"\xf1\x02\n" +
	...
	"\x06key_id\x18\x04 \x01(\tR\x05keyId\"\xba\x01\n" +
	"\x1aSpeechServiceUserStatusReq\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12\x19\n" +
	"\broom_sid\x18\x02 \x01(\tR\aroomSid\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12\x15\n" +
	"\x06key_id\x18\x04 \x01(\tR\x05keyId\x128\n" +
	"\x04task\x18\x05 \x01(\x0e2$.wemeet.SpeechServiceUserStatusTasksR\x04task*\x84\x01\n" +
	...
	"\x1aSPEECH_TO_TEXT_TOTAL_USAGE\x10\x02B\x8d\x01\n" +
	"\n" +
	"com.wemeetB\x19WemeetSpeechServicesProtoP\x01Z,github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_speech_services_proto_rawDescOnce sync.Once
	file_wemeet_speech_services_proto_rawDescData []byte
)

func file_wemeet_speech_services_proto_rawDescGZIP() []byte {
	file_wemeet_speech_services_proto_rawDescOnce.Do(func() {
		file_wemeet_speech_services_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_speech_services_proto_rawDesc), len(file_wemeet_speech_services_proto_rawDesc)))
	})
	return file_wemeet_speech_services_proto_rawDescData
}

var file_wemeet_speech_services_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wemeet_speech_services_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_wemeet_speech_services_proto_goTypes = []any{
	(SpeechServiceUserStatusTasks)(0),  // 0: wemeet.SpeechServiceUserStatusTasks
	(*SpeechToTextTranslationReq)(nil), // 1: wemeet.SpeechToTextTranslationReq
	(*GenerateAzureTokenReq)(nil),      // 2: wemeet.GenerateAzureTokenReq
	(*GenerateAzureTokenRes)(nil),      // 3: wemeet.GenerateAzureTokenRes
	(*AzureTokenRenewReq)(nil),         // 4: wemeet.AzureTokenRenewReq
	(*SpeechServiceUserStatusReq)(nil), // 5: wemeet.SpeechServiceUserStatusReq
}
var file_wemeet_speech_services_proto_depIdxs = []int32{
	0, // 0: wemeet.SpeechServiceUserStatusReq.task:type_name -> wemeet.SpeechServiceUserStatusTasks
...
func init() { file_wemeet_speech_services_proto_init() }
func file_wemeet_speech_services_proto_init() {
	if File_wemeet_speech_services_proto != nil {
		return
	}
	file_wemeet_speech_services_proto_msgTypes[0].OneofWrappers = []any{}
	file_wemeet_speech_services_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_speech_services_proto_rawDesc), len(file_wemeet_speech_services_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_speech_services_proto_goTypes,
		DependencyIndexes: file_wemeet_speech_services_proto_depIdxs,
		EnumInfos:         file_wemeet_speech_services_proto_enumTypes,
		MessageInfos:      file_wemeet_speech_services_proto_msgTypes,
	}.Build()
	File_wemeet_speech_services_proto = out.File
	file_wemeet_speech_services_proto_goTypes = nil
	file_wemeet_speech_services_proto_depIdxs = nil
}
