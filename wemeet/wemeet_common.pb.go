...
func (x *CommonNotifyEvent) Reset() {
	*x = CommonNotifyEvent{}
	mi := &file_wemeet_common_proto_msgTypes[0]
...
func (*CommonNotifyEvent) Descriptor() ([]byte, []int) {
	return file_wemeet_common_proto_rawDescGZIP(), []int{0}
}
...
func (x *NotifyEventRoom) Reset() {
	*x = NotifyEventRoom{}
	mi := &file_wemeet_common_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyEventRoom) Descriptor() ([]byte, []int) {
	return file_wemeet_common_proto_rawDescGZIP(), []int{1}
}
...
func (x *RecordingInfoEvent) Reset() {
	*x = RecordingInfoEvent{}
	mi := &file_wemeet_common_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecordingInfoEvent) Descriptor() ([]byte, []int) {
	return file_wemeet_common_proto_rawDescGZIP(), []int{2}
}
...
func (x *SpeechServiceEvent) Reset() {
	*x = SpeechServiceEvent{}
	mi := &file_wemeet_common_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpeechServiceEvent) Descriptor() ([]byte, []int) {
	return file_wemeet_common_proto_rawDescGZIP(), []int{3}
}
...
func (x *AnalyticsEvent) Reset() {
	*x = AnalyticsEvent{}
	mi := &file_wemeet_common_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsEvent) Descriptor() ([]byte, []int) {
	return file_wemeet_common_proto_rawDescGZIP(), []int{4}
}
...
var File_wemeet_common_proto protoreflect.FileDescriptor

const file_wemeet_common_proto_rawDesc = "" +
	"\n" +
	"\x13wemeet_common.proto\x12\x06wemeet\x1a\x14livekit_models.proto\"\xcb\x04\n" +
	"\x11CommonNotifyEvent\x12\x19\n" +
	"\x05event\x18\x01 \x01(\tH\x00R\x05event\x88\x01\x01\x120\n" +
	"\x04room\x18\x02 \x01(\v2\x17.wemeet.NotifyEventRoomH\x01R\x04room\x88\x01\x01\x12?\n" +
	"\vparticipant\x18\x03 \x01(\v2\x18.livekit.ParticipantInfoH\x02R\vparticipant\x88\x01\x01\x12F\n" +
	"\x0erecording_info\x18\x04 \x01(\v2\x1a.wemeet.RecordingInfoEventH\x03R\rrecordingInfo\x88\x01\x01\x12F\n" +
	"\x0espeech_service\x18\x05 \x01(\v2\x1a.wemeet.SpeechServiceEventH\x04R\rspeechService\x88\x01\x01\x12-\n" +
	"\x05track\x18\x06 \x01(\v2\x12.livekit.TrackInfoH\x05R\x05track\x88\x01\x01\x129\n" +
	"\tanalytics\x18\a \x01(\v2\x16.wemeet.AnalyticsEventH\x06R\tanalytics\x88\x01\x01\x12\x13\n" +
	...
	"\b_file_idB\x85\x01\n" +
	"\n" +
	"com.wemeetB\x11WemeetCommonProtoP\x01Z,github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_common_proto_rawDescOnce sync.Once
	file_wemeet_common_proto_rawDescData []byte
)

func file_wemeet_common_proto_rawDescGZIP() []byte {
	file_wemeet_common_proto_rawDescOnce.Do(func() {
		file_wemeet_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_common_proto_rawDesc), len(file_wemeet_common_proto_rawDesc)))
	})
	return file_wemeet_common_proto_rawDescData
}

var file_wemeet_common_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_wemeet_common_proto_goTypes = []any{
	(*CommonNotifyEvent)(nil),       // 0: wemeet.CommonNotifyEvent
	(*NotifyEventRoom)(nil),         // 1: wemeet.NotifyEventRoom
	(*RecordingInfoEvent)(nil),      // 2: wemeet.RecordingInfoEvent
	(*SpeechServiceEvent)(nil),      // 3: wemeet.SpeechServiceEvent
	(*AnalyticsEvent)(nil),          // 4: wemeet.AnalyticsEvent
...
var file_wemeet_common_proto_depIdxs = []int32{
	1, // 0: wemeet.CommonNotifyEvent.room:type_name -> wemeet.NotifyEventRoom
	5, // 1: wemeet.CommonNotifyEvent.participant:type_name -> livekit.ParticipantInfo
	2, // 2: wemeet.CommonNotifyEvent.recording_info:type_name -> wemeet.RecordingInfoEvent
	3, // 3: wemeet.CommonNotifyEvent.speech_service:type_name -> wemeet.SpeechServiceEvent
	6, // 4: wemeet.CommonNotifyEvent.track:type_name -> livekit.TrackInfo
	4, // 5: wemeet.CommonNotifyEvent.analytics:type_name -> wemeet.AnalyticsEvent
	7, // 6: wemeet.NotifyEventRoom.enabled_codecs:type_name -> livekit.Codec
...
func init() { file_wemeet_common_proto_init() }
func file_wemeet_common_proto_init() {
	if File_wemeet_common_proto != nil {
		return
	}
	file_wemeet_common_proto_msgTypes[0].OneofWrappers = []any{}
	file_wemeet_common_proto_msgTypes[1].OneofWrappers = []any{}
	file_wemeet_common_proto_msgTypes[2].OneofWrappers = []any{}
	file_wemeet_common_proto_msgTypes[3].OneofWrappers = []any{}
	file_wemeet_common_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_common_proto_rawDesc), len(file_wemeet_common_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_common_proto_goTypes,
		DependencyIndexes: file_wemeet_common_proto_depIdxs,
		MessageInfos:      file_wemeet_common_proto_msgTypes,
	}.Build()
	File_wemeet_common_proto = out.File
	file_wemeet_common_proto_goTypes = nil
	file_wemeet_common_proto_depIdxs = nil
}
