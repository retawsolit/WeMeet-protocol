...
type RecordingReq struct {
	...
	Task             RecordingTasks          `protobuf:"varint,1,opt,name=task,proto3,enum=wemeet.RecordingTasks" json:"task,omitempty"`
	...
	RecordingVariant *CloudRecordingVariants `protobuf:"varint,7,opt,name=recording_variant,json=recordingVariant,proto3,enum=wemeet.CloudRecordingVariants,oneof" json:"recording_variant,omitempty"`
...
func (x *RecordingReq) Reset() {
	*x = RecordingReq{}
	mi := &file_wemeet_recording_proto_msgTypes[0]
...
func (*RecordingReq) Descriptor() ([]byte, []int) {
	return file_wemeet_recording_proto_rawDescGZIP(), []int{0}
}
...
func (x *RecordingInfoFile) Reset() {
	*x = RecordingInfoFile{}
	mi := &file_wemeet_recording_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecordingInfoFile) Descriptor() ([]byte, []int) {
	return file_wemeet_recording_proto_rawDescGZIP(), []int{1}
}
...
var File_wemeet_recording_proto protoreflect.FileDescriptor

const file_wemeet_recording_proto_rawDesc = "" +
	"\n" +
	"\x16wemeet_recording.proto\x12\x06wemeet\x1a\x15wemeet_recorder.proto\"\xda\x02\n" +
	"\fRecordingReq\x12*\n" +
	"\x04task\x18\x01 \x01(\x0e2\x16.wemeet.RecordingTasksR\x04task\x12\x17\n" +
	...
	"\rcustom_design\x18\x06 \x01(\tH\x01R\fcustomDesign\x88\x01\x01\x12P\n" +
	"\x11recording_variant\x18\a \x01(\x0e2\x1e.wemeet.CloudRecordingVariantsH\x02R\x10recordingVariant\x88\x01\x01B\v\n" +
	"\t_rtmp_urlB\x10\n" +
	...
	"\rcreation_time\x18\v \x01(\x03R\fcreationTimeB\x88\x01\n" +
	"\n" +
	"com.wemeetB\x14WemeetRecordingProtoP\x01Z,github.com/retawsolit/WeMeet-protocol/wemeet\xa2\x02\x03WXX\xaa\x02\x06Wemeet\xca\x02\x06Wemeet\xe2\x02\x12Wemeet\\GPBMetadata\xea\x02\x06Wemeetb\x06proto3"

var (
	file_wemeet_recording_proto_rawDescOnce sync.Once
	file_wemeet_recording_proto_rawDescData []byte
)

func file_wemeet_recording_proto_rawDescGZIP() []byte {
	file_wemeet_recording_proto_rawDescOnce.Do(func() {
		file_wemeet_recording_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wemeet_recording_proto_rawDesc), len(file_wemeet_recording_proto_rawDesc)))
	})
	return file_wemeet_recording_proto_rawDescData
}

var file_wemeet_recording_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_wemeet_recording_proto_goTypes = []any{
	(*RecordingReq)(nil),        // 0: wemeet.RecordingReq
	(*RecordingInfoFile)(nil),   // 1: wemeet.RecordingInfoFile
	(RecordingTasks)(0),         // 2: wemeet.RecordingTasks
	(CloudRecordingVariants)(0), // 3: wemeet.CloudRecordingVariants
}
var file_wemeet_recording_proto_depIdxs = []int32{
	2, // 0: wemeet.RecordingReq.task:type_name -> wemeet.RecordingTasks
	3, // 1: wemeet.RecordingReq.recording_variant:type_name -> wemeet.CloudRecordingVariants
...
func init() { file_wemeet_recording_proto_init() }
func file_wemeet_recording_proto_init() {
	if File_wemeet_recording_proto != nil {
		return
	}
	file_wemeet_recorder_proto_init()
	file_wemeet_recording_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wemeet_recording_proto_rawDesc), len(file_wemeet_recording_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wemeet_recording_proto_goTypes,
		DependencyIndexes: file_wemeet_recording_proto_depIdxs,
		MessageInfos:      file_wemeet_recording_proto_msgTypes,
	}.Build()
	File_wemeet_recording_proto = out.File
	file_wemeet_recording_proto_goTypes = nil
	file_wemeet_recording_proto_depIdxs = nil
}
